...
const Header = ({ setShowUploadMusic, setShowReportQuery }) => {
    ...
    const getUserFromLocalStorage = () => {
        ...
        if (storedUser) {
            const { firstName, lastName, roleName } = storedUser;
    ...
    return (
        <div className={style.header}>
            <div className={style.headerWrapper}>
                ...
                <ReportButton setShowReportQuery ={setShowUploadMusic}/>
                    {roleName === "artist" && (
            ...
            <div className={style.playlistTextContent}>
                ...
                <div className="ml-5">
                    ...
                    <div className="flex items-center mt-5">
                        ...
                        <p>
                            <span className="text-bold">SteamBeats</span> • 2020 • 46 songs, 3 hr 20 min
                        </p>
                    </div>
                </div>
            </div>
